        ...
        <div class="row mb-5">
          <div class="col-lg-12">
            <form class="p-4 p-md-5 border rounded" action="post-job.php" method="post">
              ...
              <div class="form-group">
                <label for="job-type">Job Categories</label>
                <select name="job_category" class="selectpicker border rounded" id="job-type" data-style="btn-black" data-width="100%" data-live-search="true" title="Select Years of Experience">
              ...
              <div class="form-group">
                ...
                <input type="text" name="company_email" value="<?php echo $_SESSION['email']; ?>" class="form-control" id="" placeholder="Company Email">
              </div>
              <div class="form-group">
                <label for="">Company Name</label>
                <input type="text" value=" <?php echo $_SESSION['username']  ?>" name="company_name" class="form-control" id="" placeholder="Company Name">
              </div>
              <div class="form-group">
                <label for="">Company ID</label>
                <input type="text" name="company_id" value="<?php echo $_SESSION['id']; ?>" class="form-control" id="" placeholder="Company ID">
              </div>
              <div class="form-group">
                <label for="">Company Image</label>
                <input type="text" value="<?php echo $_SESSION['image']; ?>" name="company_image" class="form-control" id="" placeholder="Company Image">
              </div>
